//
//  SSListItemExtraDetailsTableViewCell.m
//  Spend Stack
//
...
@interface SSListItemExtraDetailsTableViewCell()
...
@implementation SSListItemExtraDetailsTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        self.listItemBaseAndTaxAmountLabel.mas_key = @"listItemBaseAndTaxAmountLabel";
...
- (void)setConstraints
{
    ...
    else
    {
        ...
        [self.listItemNameLabel mas_remakeConstraints:^(MASConstraintMaker *make) {
            ...
            make.right.equalTo(self.listItemTotalPriceLabel.mas_left).with.offset(SSRightElementMargin);
            make.width.lessThanOrEqualTo(self.dividerView.mas_width).multipliedBy(.64f).with.priorityHigh();
        }];
        ...
        [self.listItemTotalPriceLabel mas_remakeConstraints:^(MASConstraintMaker *make) {
            ...
            make.width.greaterThanOrEqualTo(@60).with.priorityHigh();
