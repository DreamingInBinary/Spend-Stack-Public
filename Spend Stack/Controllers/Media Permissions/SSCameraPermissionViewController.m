//
//  SSCameraPermissionViewController.m
//  Spend Stack
//
...
@interface SSCameraPermissionViewController ()
...
@implementation SSCameraPermissionViewController
...
- (void)viewDidLoad
{
    ...
    self.mediaromptLabel.text = @"Spend Stack needs your permission to use your camera.\n\nIf that sounds good, please grant us permissions within settings.";
    ...
    UIImageSymbolConfiguration *symbolConfig = [UIImageSymbolConfiguration configurationWithPointSize:38];
    UIImage *cameraIcon = [[UIImage systemImageNamed:@"camera.fill" withConfiguration:symbolConfig] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
